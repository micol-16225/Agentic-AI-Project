...
class BiostatLifecycleAgent3:
    ...
    def audit_protocol(self, user_protocol, historical_lessons, user_directives=""):
        ...
        ### TRUTH ANCHORING RULES:
        1. You may use **Bold Text** for headers and emphasis to make the report readable.
        2. However, any direct evidence or regulatory requirements MUST be placed inside "double quotes".
        3. Any text inside "double quotes" MUST be a 100% verbatim match from the provided Knowledge Base.
        4. If you quote something that is NOT in the library, the audit will fail.
